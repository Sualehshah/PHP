        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="product.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Products</a>
                    <div class="dropdown-menu bg-transparent border-0">
                            <a href="addProduct.php" class="dropdown-item">Add Product</a>
                            <a href="viewProduct.php" class="dropdown-item">View Prodcut</a>
                        </div>
                    <a href="order.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Orders</a>
                    <a href="Reviews.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Reviews</a>
                    <a href="Notifications.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Notifications</a>
                    <div class="nav-item dropdown">
                        <a href="invoices.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>invoices</a>
                        <div class="dropdown-menu bg-transparent border-0">
